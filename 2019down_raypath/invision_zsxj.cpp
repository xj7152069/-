...
double G[M][N]={0.0},T[M][1]={0.0},T2[M][1]={0.0},DT[M][1]={0.0},GT[N][M]={0.0},GTG[N][N]={0.0},G_1[N][M]={0.0},U[N][N]={0.0},UT[N][N]={0.0},AU[N][N]={0.0},K_1[N][N]={0.0},K_1_GT[N][M]={0.0},model[N][1]={0.0},P[N][1]={0.0},GTd[N][1]={0.0};
...
int main()
{
     ...
     double raypath[9999][3]={-1.0},maxdm,mindm;
     ifstream infile;
     ofstream outf;
...
{ 
    ...
    while(1)
  {
   ...
   {for(j=0;j<Z;j++)
    {   
        model1[i][j]=modeldd[i][j]-ddbc*(P[X*(j)+i][0]);
