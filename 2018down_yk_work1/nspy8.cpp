...
{        float t1;
     ...
     ofstream outf;
     ofstream outf1;
int D,N1,N2,X1,Y1,k,k1,X,T,i,j,i1,j1,Y,i2,j2,js(0);
...
cout<<"please save the data as 'model', it's a bin file. "<<endl;
...
cin>>N1;
cout<<"please input the number of surface(N)"<<endl;
cin>>N2;
...
//!!!!!!!!!!!!!!!!!
   ...
   infile.close();
    ...
    outf.open("fy2");
     ...
     outf.close();
     cout<<"the data has been saved as 'fy2' "<<endl;}
...
////////////////////////逆时传播////////////////////////////////////////
   if(a1==1)
     ...
     for(k=0;k<T;k++)  //!!!!!!!!!逆时传播比顺时传播少了一个时间片！！！！
       {js=0;
        // cout<<k<<endl;
        for(i=5;i<X+5;i++)
       {for(j=5;j<Y+5;j++)
