...
int D,T,X,Y,i,j,i1,j1,k,n1,wz_cdp,k3,k4,N1,N2;
...
cout<<"please input the beginning site (N1)"<<endl;  //起始文件编号
cin>>N1;
cout<<"please input the number of movie(N2)"<<endl;  //终止文件编号
cin>>N2;
cout<<"please input the gap(D)"<<endl;  //地表震源间隔，同时应是各个文件编号间隔
cin>>D;
cout<<"please input the X"<<endl;  //模型参数
cin>>X;
