...
////////////////////////定义变量，并初始化////////////////////////
   float sjyc(0.04),xsxs,DX,DY,DT,a91,a1,a2,a3,a4,a5,a6,a7,a8,a9,xf,yf,t,x,z,dx,dy,ddx,ddy,snx1,sny1,snx2,sny2,t2,t5;
    int T,i,j,k,n,n1,i1,j1,t3,t4,N,D,m,X,Y,N1;
    ...
    a91=0,a9=-9;t=0.001,t2=0,x=0,z=0,yf=40,xf=200,X=300,Y=150,T=1000,DX=10,DY=10,DT=0.001,a1=-9,a2=-9,a3=-9,a4=-9,a5=-9,a6=1,a7=-9,a8=-9;
/////////////////////////////////////////////////////////////////
       ...
       {for(j=5;j<Y+5;j++)
        {
           ...
           if(j==40 && i==N1+m*D)
{f=(3.1415926)*(3.1415926)*900*(k*DT-sjyc)*exp((-3.1415*3.1415*900*(k*DT-sjyc)*(DT*k-sjyc)))*(3-2*3.1415*3.1415*900*(k*DT-sjyc)*(DT*k-sjyc));
/*f=exp((-3.1415*3.1415*900*(k*DT-sjyc)*(k*DT-sjyc)))*(3-2*3.1415*3.1415*900*(k*DT-sjyc)*(k*DT-sjyc));*/ }
           else {f=0;}
