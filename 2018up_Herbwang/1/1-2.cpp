...
{if(x5[i1]<=1.5*sh)
	...
	{p5[i1]=((f3[0]*(x5[i1]-x3[1])*(x5[i1]-x3[2]))/((x3 [0]-x3[1])*(x3[0]-x3[2]))
		+(f3[1]*(x5[i1]-x3[0])*(x5[i1]-x3[2]))/((x3 [1]-x3[0])*(x3[1]-x3[2]))
		+ (f3[2]*(x5[i1]-x3[0])*(x5[i1]-x3[1]))/((x3 [2]-x3[0])*(x3[2]-x3[1])));
	 f5[i1]=1/(1+25*x5[i1]*x5[i1]);
