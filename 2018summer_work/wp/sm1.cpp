...
int main()
{ cout<<ec(10,20,30,20,20,30).imag()<<muls(e_c(10,20,30,20,20,30),2.0)<<endl;
 cout<<add(ec(10,20,30,20,20,30),e_c(10,20,30,20,20,30))<<endl;
  //////////////////////////////////////////////////////////////////定义变量，并初始化///////////////////////////////////////////////////////
   float T,DX,DY,DT,a1,a2,a3,a4,a5,a6,a7,a8,xf,t,x,z,dx,dy,ddx,ddy,snx1,sny1,snx2,sny2,t2,t5,r;
	...
	complex<float> v[300][300],vf[300][300],b1,b2,b3,k1,k2,k3,k4;
    t=0.001,t2=298,x=0,z=0,xf=150,X=300,Y=300,T=300,DX=10,DY=10,DT=0.001,a1=-9,a2=-9,a3=-9,a4=-9,a5=1,a6=1,a7=1,a8=-9,MM=X,NN=Y;
    for (i=0;i<300;i++)
      {for(j=0;j<300;j++)
        {p2[i][j]=3000;
         v[i][j]=0.0;
