...
if(j==40 )
   {for(i1=1;i1<k1;i1++)
     {f[k][i-5]=f[k][i-5]+s[T-i1][i-5]*exp((-3.1415*3.1415*900*(t[i1]*DT-sjyc)*(t[i1]*DT-sjyc)))*(3-2*3.1415*3.1415*900*(t[i1]*DT-sjyc)*(t[i1]*DT-sjyc));   
     }
   }
if(j==40 )
     {f[k][i-5]=f[k][i-5]+s[T-k][i-5]*exp((-3.1415*3.1415*900*(DT-sjyc)*(DT-sjyc)))*(3-2*3.1415*3.1415*900*(DT-sjyc)*(DT-sjyc));}
...
for(i=5;i<X+5;i++)
  {for(j=5;j<Y+5;j++)
     {outf.write((char*)&s2[j][i],sizeof(s2[j][i]));}}
     outf.close();
