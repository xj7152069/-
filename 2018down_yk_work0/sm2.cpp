...
////////////////////////定义变量，并初始化////////////////////////
   float xsxs,DX,DY,DT,a91,a1,a2,a3,a4,a5,a6,a7,a8,a9,xf,t,x,z,dx,dy,ddx,ddy,snx1,sny1,snx2,sny2,t2,t5;
    int T,i,j,k,n,n1,i1,j1,t3,t4,N,D,m,X,Y;
    ...
    a91=0,a9=-9;t=0.001,t2=0,x=0,z=0,xf=200,X=400,Y=200,T=800,DX=10,DY=10,DT=0.001,a1=-9,a2=-9,a3=-9,a4=-9,a5=-9,a6=1,a7=-9,a8=-9;
/////////////////////////////////////////////////////////////////
...
for(j1=0;j1<T;j1++)
{for(i1=0;i1<N;i1++)
 {outf8.write((char*)&s4[j1][i1*D+35],sizeof(s4[j1][i1*D+35]));}
}
